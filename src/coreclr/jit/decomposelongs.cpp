...
GenTree* DecomposeLongs::DecomposeHWIntrinsicToScalar(LIR::Use& use, GenTreeHWIntrinsic* node)
{
    ...
    if (m_compiler->compOpportunisticallyDependsOn(InstructionSet_SSE42))
    {
        ...
        hiResult     = m_compiler->gtNewSimdGetElementNode(TYP_INT, simdTmpVar, one, TYP_INT, simdSize);
    ...
    else
    {
        ...
        hiResult           = m_compiler->gtNewSimdToScalarNode(TYP_INT, shift, TYP_INT, simdSize);
